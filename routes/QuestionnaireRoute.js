...
router.get('/admin/get-all', authorized(['SUPER_ADMIN', 'ADMIN', 'DIRECTOR']), QuestionnaireController.getAllQuestionnaires);
...
router.get('/admin/get-by-email/:email', authorized(['SUPER_ADMIN', 'ADMIN', 'DIRECTOR']), QuestionnaireController.getQuestionnairesByEmail);
router.delete('/admin/delete/:id', authorized(['SUPER_ADMIN', 'ADMIN', 'DIRECTOR']), QuestionnaireController.deleteQuestionnaire);
